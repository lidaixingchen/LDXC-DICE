...
export { default as CombatManager } from '../combat/CombatManager.vue';
...
export { default as StatusPanel } from '../combat/StatusPanel.vue';
export { default as ToolsPanel } from '../tools/ToolsPanel.vue';
